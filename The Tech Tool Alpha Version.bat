...
echo 4. Automatic Scripts Menu
echo 5. Delete SoftwareDistribution folder contents
echo 6. Trigger Defender signature update
echo 7. Reboot into BIOS after 10 seconds
echo 8. Exit
echo(
echo ================================
set /p choicemain=Choose an option (1-8):

if "%choicemain%"=="1" goto NETWORKMENU
if "%choicemain%"=="2" goto REMNANTSMENU
if "%choicemain%"=="3" goto REPAIRMENU
if "%choicemain%"=="4" goto AUTOSCRIPT
if "%choicemain%"=="5" goto DELETESWD
if "%choicemain%"=="6" goto DEFUPDATE
if "%choicemain%"=="7" goto BIOSBOOT
if "%choicemain%"=="8" goto Exit
goto MENU
